...
import {
  BoardsAlterationsChangedRecord,
  DataboardBoardsAlterationsManagerService,
} from '../services/databoard-boards-alterations-manager.service'
...
import { DatapageComponent } from '@theseam/ui-common/datapage'
...
class MockBoardsAlterationsManagerService
  implements Partial<DataboardBoardsAlterationsManagerService>
{
  public add(
    alterations: BoardsAlteration[],
...
export default {
  ...
  decorators: [
    ...
    moduleMetadata({
      imports: [TheSeamDataFiltersModule, TheSeamDataboardModule],
      providers: [
        // {
...
type Story = StoryObj<DataboardBoardPreferencesButtonComponent>
      ...
      providers: [
        {
          ...
          useClass: MockDataboardList,
        },
        {
          provide: DataboardBoardsAlterationsManagerService,
          useClass: MockBoardsAlterationsManagerService,
        },
      ],
    },
    props: {},
