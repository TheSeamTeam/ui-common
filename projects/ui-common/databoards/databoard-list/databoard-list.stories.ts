...
const boardAddPredicate = (
  drag: CdkDrag<DataboardCard>,
  targetList: CdkDropList<DataboardBoardCards>,
) => {
...
const boardContentPredicate: DataboardPredicate = (
  card: DataboardCard,
  board: DataboardBoardCards,
) => {
...
const boards: DataboardBoard[] = [
  ...
  },
  {
    ...
    confirmReorderMessage: {
      ...
      alert: {
        message:
          'This will not affect the order in which loads are displayed to other users.',
        theme: 'info',
      },
    },
  },
...
type Story = StoryObj<DataboardListComponent>
...
export const Simple: Story = (args: any) => ({
  props: {
    ...
    updateStatus(event: CdkDragDrop<DataboardBoardCards>) {
      console.log(
        `updateStatus: update load ${event.item.data.loadId} to ${event.container.data.prop}`,
      )
    },
  ...
  template: `<seam-databoard-list
              ...
              <ng-template seamDataboardFooterTpl let-board></ng-template>
              ...
              <ng-template seamDataboardCardTpl let-card>
                <div class="d-flex align-items-end justify-content-between">
                  ...
                  <seam-datatable-action-menu>
                    <seam-datatable-action-menu-item label="View" (click)="openViewModal(card)"></seam-datatable-action-menu-item>
                    <seam-datatable-action-menu-item label="Edit" (click)="openEditModal(card)"></seam-datatable-action-menu-item>
                    <seam-datatable-action-menu-item label="Open Google" href="https://google.com" target="_blank" [confirmDialog]="{ message: 'Are you sure you want to leave the site?' }"></seam-datatable-action-menu-item>
                  </seam-datatable-action-menu>
                </div>
                <div class="d-flex align-items-end justify-content-between">
