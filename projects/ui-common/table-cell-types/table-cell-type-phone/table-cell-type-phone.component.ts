...
import {
  coercePhoneNumberFormat,
  THESEAM_DEFAULT_PHONE_NUMBER_FORMAT,
} from '@theseam/ui-common/tel-input'
...
export class TableCellTypePhoneComponent implements OnDestroy {
  ...
  @Input()
  set format(value: intlTelInputUtils.numberFormat) {
  ...
  constructor(
    ...
    _tableData?: TableCellData<'phone', TableCellTypeConfigPhone>,
  ) {
    ...
    if (
      ...
      this.format = _data.colData.cellTypeConfig
        .format as intlTelInputUtils.numberFormat
    }
