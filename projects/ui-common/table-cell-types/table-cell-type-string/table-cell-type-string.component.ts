...
import {
  ...
  TableCellTypeStringConfigAction,
} from './table-cell-type-string-config'
...
export class TableCellTypeStringComponent implements OnInit, OnDestroy {
  ...
  @HostBinding('attr.title') get _titleAttr() {
  ...
  @HostBinding('attr.style') get _styleAttr() {
    return this.style
  }

  @Input()
  set classAttr(value: string | undefined) {
    this._class = value
  }
  get classAttr(): string | undefined {
    return this._class
  }

  @HostBinding('class') get _classAttr() {
  ...
  constructor(
    ...
    readonly _tableData?: TableCellData<'string', TableCellTypeConfigString>,
  ) {
