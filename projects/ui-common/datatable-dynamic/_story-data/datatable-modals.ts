...
@Component({
  template: `
    <seam-modal-header>
      <h4 seamModalTitle class="d-flex flex-column">Story Modal 1</h4>
      <button
        type="button"
        class="close"
        aria-label="Close"
...
export class StoryModalOneComponent {
  constructor(@Optional() @Inject(MODAL_DATA) public data?: any) {
...
@NgModule({
  ...
  declarations: [StoryModalOneComponent],
})
...
@Component({
  template: `
    <seam-modal-header>
      <h4 seamModalTitle class="d-flex flex-column">Story Modal 2</h4>
      <button
        type="button"
        class="close"
        aria-label="Close"
...
@NgModule({
  ...
  declarations: [StoryModalTwoComponent],
})
