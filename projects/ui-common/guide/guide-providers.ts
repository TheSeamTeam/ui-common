...
export interface TheSeamGuideProviderOptions {
  /** Replace the presentation engine. Defaults to the built-in adapter. */
 ...
 *
 * The engine is named only here — no consumer imports the underlying library
 * directly — so replacing it is a change to this call, not to application code.
 */
