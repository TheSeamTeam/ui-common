...
import {
  ...
  TheSeamDatatableColumnFilterableConfig,
} from './table-column'
...
export interface ColumnsDataFilterState<T = any, O = any>
  extends DataFilterState {
  state: ColumnsDataFilterStateState<T, O>
}

export abstract class ColumnsDataFilter<
  TInitial = any,
  TForm = FormGroup,
  TOptions = any,
  TConfig extends TheSeamDatatableColumnFilterableConfig = any,
> implements DataFilter
{
   ...
   */
  public abstract dataFilter(
    data: any[],
    filterValue: TInitial,
    options: any,
  ): any[]
...
export const THESEAM_COLUMNS_DATA_FILTER = new InjectionToken<
  ColumnsDataFilter<any, any>
>('ColumnsDataFilter')
