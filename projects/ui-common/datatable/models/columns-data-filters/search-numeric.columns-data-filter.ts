...
import {
  ...
  THESEAM_COLUMNS_DATA_FILTER_NUMERIC_SELECT_SEARCH_TYPES,
} from './models'

export class SearchNumericColumnsDataFilter extends ColumnsDataFilter<
  TheSeamColumnsDataFilterNumericSearchFormState,
  TheSeamColumnsDataFilterNumericSearchForm,
  undefined
> {
  ...
  constructor(
    ...
    this.form = new FormGroup({
      searchType:
        new FormControl<TheSeamColumnsDataFilterNumericSearchType | null>(
  ...
  public dataFilter(
    data: any[],
    filterValue: Partial<TheSeamColumnsDataFilterNumericSearchFormState>,
    options: any,
  ): any[] {
    ...
    return this.numberSearchDataFilter(
      this.prop,
      data,
  ...
  private _isInvalidSearchTerm(
    ...
    fromText: number,
    toText: number,
    comparator: TheSeamColumnsDataFilterNumericSearchType,
  ): boolean {
    if (
      isNaN(searchText) &&
  ...
  public isDefault(): boolean {
    ...
    if (isNullOrUndefinedOrEmpty(formValue.searchType)) {
      ...
      THESEAM_COLUMNS_DATA_FILTER_NUMERIC_SELECT_SEARCH_TYPES.includes(
