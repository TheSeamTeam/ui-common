...
} from '../models/columns-alteration'
import { FilterColumnsAlteration } from '../models/columns-alterations/filter.columns-alteration'
...
export function mapColumnsAlterationsStates(
  states: ColumnsAlterationState[],
): ColumnsAlteration[] {
