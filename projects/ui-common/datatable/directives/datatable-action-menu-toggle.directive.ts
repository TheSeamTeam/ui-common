...
export class DatatableActionMenuToggleDirective {
  @Input() seamDatatableActionMenuToggle:
  ...
  @HostListener('mousedown', ['$event']) _mouseDown(event: any) {
    this.onInputDown(event)
  }
  @HostListener('pointerdown', ['$event']) _pointerDown(event: any) {
    this.onInputDown(event)
  }

  @HostListener('mouseup', ['$event']) _mouseUp(event: any) {
    this.onInputUp(event)
  }
  @HostListener('pointerup', ['$event']) _pointerUp(event: any) {
    this.onInputUp(event)
  }
  ...
  public enable() {
    ...
    this._overlayRef.attach(
      new TemplatePortal(
        this.seamDatatableActionMenuToggle,
