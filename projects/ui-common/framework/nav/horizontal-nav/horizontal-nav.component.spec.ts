...
//   let spectator: SpectatorRouting<HorizontalNavComponent>
...
//       expect(spectator.queryAll('seam-nav-item').length).toBe(6)
//       expect(spectator.queryAll('seam-nav-item[data-hier-level="0"]').length).toBe(3)
//       expect(spectator.queryAll('seam-nav-item[data-hier-level="1"]').length).toBe(2)
//       expect(spectator.queryAll('seam-nav-item[data-hier-level="2"]').length).toBe(1)
//     }))
//   })
