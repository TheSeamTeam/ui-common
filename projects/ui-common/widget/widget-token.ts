...
export const THESEAM_WIDGETS = new InjectionToken<IWidgetRegistryRecord>(
  'TheSeamWidgets',
)
...
export const THESEAM_WIDGET_DEFAULTS =
  new InjectionToken<TheSeamWidgetDefaults>('TheSeamWidgetDefaults')
